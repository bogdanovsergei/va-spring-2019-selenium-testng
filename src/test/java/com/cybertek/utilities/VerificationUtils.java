...
public class VerificationUtils {
    ...
    public static void verifySelected(WebElement element, boolean checked) {
        ...
        //checked is what we are expecting
        if (checked) {
    ...
    // return false when 1. element is not found and not visible. 2. element not found. returns true if element found and displayed
    //  @param driver
    //  @param by
